...
var sureshSamples=0, savitaSamples=0, vikasSamples=0, rajanSamples=0, akashSamples=0;
...
function handleButton(elem){
	switch(elem.id){
		case "0":
			sureshSamples++;
			document.getElementById("sureshsamples").innerText = "Suresh samples:" + sureshSamples;
			break;
		case "1":
			savitaSamples++;
			document.getElementById("savitasamples").innerText = "Savita samples:" + savitaSamples;
			break;
		case "2":
			vikasSamples++;
			document.getElementById("vikassamples").innerText = "Vikas samples:" + vikasSamples;
			break;  
		case "3":
			rajanSamples++;
			document.getElementById("rajansamples").innerText = "Rajan samples:" + rajanSamples;
			break;
        case "4":
            akashSamples++;
            document.getElementById("akashsamples").innerText = "Akash samples:" + akashSamples;
            break;
	}
...
async function predict() {
  while (isPredicting) {
    ...
    switch(classId){
		case 0:
			predictionText = "Suresh Rawat";
			break;
		case 1:
			predictionText = "Savita Rawat";
			break;
		case 2:
			predictionText = "Vikas Rawat";
			break;
		case 3:
			predictionText = "Rajan Rawat";
			break;
        case 4:
            predictionText = "Akash Rawat";
            break;
	}
